...
const PhimBo: ComponentLayout<PropType> = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            // lấy hết list Genre
            await movieApi
                .getAllMoviesGenres(CONSTANTS_MOVIE.PHIM_BO_ID)
                .then((response) => {
