...
const DangNhap: ComponentLayout = () => {
    ...
    const { t } = useTranslation('dang-nhap');
        ...
        html = (
            <div className='buttonWrapper '>
                <button type='submit' className='button buttonNextStep'>
                    {loginStep === 'phone' ? t('tiep_tuc') : t('xong')}
                </button>
                <style jsx>{styles}</style>
            </div>
        );
                ...
                <div className='poster'>
                    ...
                    <div className='content'>
                        <div className='rowContainer'>
                            ...
                            <form className='form' onSubmit={handleSubmit}>
                                <h3 className='label'>{t('welcomeText')}</h3>
                                {/* <Link
                                    href='/dang-nhap'
                                    locale={
...
export const getStaticProps: GetStaticProps = async ({ locale }: any) => ({
    props: {
        ...(await serverSideTranslations(locale, ['common', 'dang-nhap'])),
    },
});
