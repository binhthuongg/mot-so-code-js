...
const TaiLieu: ComponentLayout<PropType> = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            // lấy hết list Genre
            await movieApi
                .getAllMoviesGenres(CONSTANTS_MOVIE.TAI_LIEU_ID)
                .then((response) => {
...
TaiLieu.Layout = LayoutNoSidebar;
