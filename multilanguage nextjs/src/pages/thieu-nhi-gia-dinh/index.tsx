...
const ThieuNhiGiaDinh: ComponentLayout<PropType> = () => {
        ...
        try {
            ...
            await movieApi
                .getMoviesByGenreIdAndTypeId(
                    ...
                    CONSTANTS_MOVIE.THIEU_NHI_GIA_DINH_ID,
                )
                .then((response) => {
            ...
            // lấy hết list Genre
            await movieApi
                .getAllMoviesGenres(CONSTANTS_MOVIE.THIEU_NHI_GIA_DINH_ID)
                .then((response) => {
    ...
    return (
        <div className='ThieuNhiGiaDinhWrapper'>
            <Head>
                <title>Thiếu nhi gia đình</title>
            </Head>
...
ThieuNhiGiaDinh.Layout = LayoutNoSidebar;

export default ThieuNhiGiaDinh;
