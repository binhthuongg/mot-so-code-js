...
const HBOGoThieuNhiGiaDinh: ComponentLayout = () => {
    ...
    return (
        <div className='HBOWrapper'>
            <Head>
                <title>Thiếu nhi gia đình HBO</title>
            </Head>
...
HBOGoThieuNhiGiaDinh.Layout = LayoutChanel;

export default HBOGoThieuNhiGiaDinh;
