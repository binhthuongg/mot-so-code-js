...
const ChauA: ComponentLayout<PropType> = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            // lấy hết list Genre
            await movieApi
                .getAllMoviesGenres(CONSTANTS_MOVIE.CHAU_A_ID)
                .then((response) => {
